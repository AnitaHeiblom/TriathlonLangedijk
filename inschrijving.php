    ...
    <div class="main-content">
        <div class="row">
            <div class="col-12 col-lg-8 col-md-9 col-sm-12">
                <h2>Inschrijving</h2>
                <p>De inschrijving  voor individuelen en trio’s vindt plaats via <a href="https://www.ntbinschrijvingen.nl/">NTB-inschrijvingen</a>.
                    <br>
                    <br>
                    De inschrijving voor de editie van 2018 begint op zaterdag, 3 februari 2018 ’s nachts om 00.00 uur.
                    <br>
                    <br>
                    Heb je twijfels of je inschrijving wel goed is gegaan dan kun je dit checken door een mail te sturen naar
                    <a href="mailto:triathlonlangedijk@hotmail.com?Subject=Inschrijving%202018">triatlonlangedijk@hotmail.com</a>. Je krijgt dan een bericht of je correct staat ingeschreven.
                </p>
            </div>
