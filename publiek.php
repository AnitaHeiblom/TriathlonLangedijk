    ...
    <div class="main-content">
        <div class="row">
            <div class="col-12 col-lg-8 col-md-9 col-sm-12">
                <h2>Publiek</h2>
                <p>Ook voor het publiek is het evenement prima te volgen, doordat de atleten meerdere malen voorbij komen. Dat bleek de afgelopen jaren toen het publiek in grote getale langs het parcours stond.
                    <br>
